...
| Type          | Description                           |
|---------------|---------------------------------------|
| [`sram_wr_if.server`](../tinytracer_if.md#sram_wr_if)  | SRAM write request channel from the I/O Unit |
| [`sram_rd_if.server`](../tinytracer_if.md#sram_rd_if)  | SRAM read request and response channel from the RTU |
